...
export const HeaderComponent = () => {
    ...
    // Cambia il value dell'input quando rileva una modifica
    function changeValue(e) {
        e.preventDefault();
        setSearchBar(e.target.value);
    }

    // Chiamata axios filtrata in base ai valori di ricerca inseriti nella searchbar
    const getFiltredMovies = () => {
        axios
            .get(
                `https://api.themoviedb.org/3/search/movie?query=${searchBar}&${import.meta.env.VITE_API_KEY}&language=it-IT&page=1`
            )
        ...
        axios
            .get(
                `https://api.themoviedb.org/3/search/tv?query=${searchBar}&${import.meta.env.VITE_API_KEY}&language=it-IT&page=1`
            )
